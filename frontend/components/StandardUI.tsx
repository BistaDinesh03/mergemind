...
// Standard Button
export function Btn({ children, variant = "primary", size = "md", href, external, className = "", ...props }) {
  ...
  const sizes = { sm: "h-9 px-3 text-xs gap-1.5", md: "h-11 px-5 text-sm gap-2", lg: "h-[52px] px-8 text-base gap-2.5" }
