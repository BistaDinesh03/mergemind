    ...
    <div className="min-h-screen bg-[#09090b] text-white"><Navbar />
      <main className="max-w-4xl mx-auto px-6 py-8 space-y-8 animate-fadeIn">
        ...
        {progress.saved > 0 && (
          <section className="bg-[#18181b] border border-[#27272a] rounded-[20px] p-6">
            <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
              <Bookmark className="w-5 h-5 text-yellow-400" /> Saved for Later
            </h2>
            <p className="text-sm text-zinc-400 mb-3">
              You have {progress.saved} saved issue{progress.saved > 1 ? "s" : ""} — ready when you are.
            </p>
            <Link href="/discover" className="text-sm text-purple-400 hover:text-purple-300 inline-flex items-center gap-1">
              Browse more issues <ArrowRight className="w-3 h-3" />
            </Link>
          </section>
        )}
